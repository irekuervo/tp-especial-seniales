...
for i =1:20
    ...
    for k = 1:4 % recorremos los audios
        tau_temporal = utils.tau_ventaneo_resampleado(mics(:,k),mics(:,k+1),Nw,fs,@hamming);
...
utils.print('Ej6_Hamming_Histograma_12');
figure
histogram(gcc_ventaneo_upsample(:,2),1000)
utils.print('Ej6_Hamming_Histograma_23');
figure
histogram(gcc_ventaneo_upsample(:,3),1000)
utils.print('Ej6_Hamming_Histograma_34');
figure
histogram(gcc_ventaneo_upsample(:,4),1000)
utils.print('Ej6_Hamming_Histograma_45');
